...
void turnBack()
{
    ...
    rightBase=176;
    leftBase=180;
    encoderRightCount= encoderRightCount + 750;
    encoderLeftCount= encoderLeftCount + 750;
    while(rightEncoder <= encoderRightCount || leftEncoder <= encoderLeftCount)
    {
        turnRight();
    }
...
void rightAboutTurn()
{
    ...
    rightBase=176;
    leftBase=180;
    encoderRightCount= encoderRightCount + 270;
    encoderLeftCount= encoderLeftCount + 270;
...
void leftAboutTurn()
{
    ...
    rightBase=176;
    leftBase=180;
    encoderRightCount= encoderRightCount + 240; //255
    encoderLeftCount= encoderLeftCount + 240;   //255
    while(rightEncoder <= encoderRightCount)
    {
        turnLeft();
    }
